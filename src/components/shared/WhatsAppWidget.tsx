...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {open && (
        <div className="w-80 rounded-xl border border-gold/30 bg-navy-light p-4 shadow-2xl">
          <div className="flex items-center justify-between">
            <h3 className="font-serif text-base font-semibold text-gold">
              Chat with OpulenPort Trading
            </h3>
            <button
              type="button"
          ...
          <p className="mt-2 text-sm text-cream/80">
            Questions about sourcing or importation? Message us directly.
          </p>
          <a
            href={buildWhatsAppLink("Hi, I'd like to know more about your services.")}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-3 inline-flex w-full items-center justify-center rounded-md bg-gold px-4 py-2 text-sm font-semibold text-navy transition-colors hover:bg-gold-bright"
          >
      ...
      <div className="relative">
        ...
        <button
          ...
          className="relative flex h-14 w-14 items-center justify-center rounded-full bg-gold text-navy shadow-lg transition-transform hover:scale-105"
